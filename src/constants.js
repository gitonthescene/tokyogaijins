...
export const gaitersizeOpts = ["No", "S", "M", "L", "XL"];

export const jacketpantsizeOpts = [NOTNEEDED, "XS", "S", "M", "L", "XL"];

export const glovesizeOpts = [NOTNEEDED, "S", "M", "L", "XL"];

export const bodysizeOpts = ["No", "S", "M", "L", "XL"];

export const neededOpts = [NOTNEEDED, "Yes"];

export const YesNo = ["Yes", "No"];

export const YesNoMaybe = ["Yes", "No", "Will decide later"];
...
export const roomOptsByEvent = {
  C: [2, 7, 8, 9].map<string>((idx: number): string => roomOpts[idx]),
  S: [1, 3, 5, 9, 11].map<string>((idx: number): string => roomOpts[idx]),
  M: [1, 3, 5, 9, 11].map<string>((idx: number): string => roomOpts[idx]),
  H: [1, 3, 5, 9, 11].map<string>((idx: number): string => roomOpts[idx]),
  I: [1, 3, 5, 9, 10, 11].map<string>((idx: number): string => roomOpts[idx]),
  N: [1, 3, 5, 9, 11].map<string>((idx: number): string => roomOpts[idx]),
  Z: [1, 3, 5, 9, 11].map<string>((idx: number): string => roomOpts[idx]),
  default: [1, 3, 4, 6, 9].map<string>((idx: number): string => roomOpts[idx]),
};
...
export const events = ["", "Ski", "Non-ski", "Zao", "Snow Monkey"];
...
export const swimmingskillOpts = ["Beginner", "Intermediate", "Advanced"];
